...
public class ByteArrayBinarySerializer implements Serializer<Object, ByteArrayTypeHandler> {

    @Override
    public int size(Object value) {
        return BinarySerialization.SIZE_TAG_LENGTH + getPrimitiveArray(value).length;
    }
