...
public interface Journal extends Service {
    ...
    /**
     * Iterate over events generated by a specific command (through {@code EntityHandler<T>})
     *
     * @param uuid command UUID
     * @param <T>
     * @return iterator
     */
    <T extends Event> CloseableIterator<EntityHandle<T>> commandEventsIterator(UUID uuid);
